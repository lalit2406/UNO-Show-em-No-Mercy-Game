    ...
    <div className="relative min-h-screen w-full max-w-full bg-slate-950 flex justify-center items-center p-6 text-white select-none overflow-hidden">
      ...
      <div className="max-w-md w-full bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.8)] flex flex-col items-center relative z-10 ring-1 ring-white/5">
        ...
        <div className="flex flex-col items-center mb-8 relative select-none">
          ...
          <span className="text-[9px] font-black text-slate-500 tracking-[0.3em] uppercase mt-4">
            ROOM CREATION ARENA
          </span>
        </div>
          ...
          <div className="w-full space-y-6">
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <button
                ...
                className="w-full py-4 rounded-2xl bg-slate-950/60 hover:bg-slate-900 border border-slate-850 hover:border-slate-700 font-bold text-slate-400 hover:text-white hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 shadow-lg"
              >
                Join Private Lobby
              </button>
            </div>
            ...
            <div className="flex justify-center items-center gap-4 pt-4 border-t border-slate-800/50 text-[10px] font-black uppercase tracking-wider select-none text-slate-500">
              <button
                type="button"
